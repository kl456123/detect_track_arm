...
* \param pData 设备数据，例如ImrModulePose,ImrTrig
...
namespace indem {
    ...
    struct MRCONFIG {
        ...
        IMG_RESOLUTION imgResolution; //图像分辨率，默认1280X800
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        /*
         * \brief 在加载slam动态库后调用Init之前，进行某些自定义设置
         * @param inParam 需要传的参数
         */
        void BeforeSlamInit(void* inParam);

        /*
        * \brief 以指定的值重新初始化slam,如果slam动态库实现了初始化操作
         * @param t     时间
         * @param pos   位置[x,y,z]
         * @param quart 姿态
         * @param speed 速度
